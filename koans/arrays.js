...
test("Sparse arrays", assert => {
  const sparse = [];

  // JavaScript supports "sparse" arrays but can be a little weird to work with

  sparse[99] = 1;

  assert(__, sparse.length, 'Perhaps not what you might first think.');
});
